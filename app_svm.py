...
model = joblib.load('svm_brain_tumor_model.joblib')
...
@app.route('/')
def home():
    return render_template('index_svm.html')
...
def predict():
    if request.method == 'POST':
        ...
        if image:
            ...
            return render_template('index_svm.html', result=result)
        else:
            print("No image received.")

    return render_template('index_svm.html')  # Return to home if something goes wrong
